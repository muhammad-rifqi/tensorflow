...
Promise.all([
	faceapi.nets.tinyFaceDetector.loadFromUri('/testing-disini/tensor/v1/models'),
	faceapi.nets.faceLandmark68Net.loadFromUri('/testing-disini/tensor/v1/models'),
	faceapi.nets.faceRecognitionNet.loadFromUri('/testing-disini/tensor/v1/models'),
	faceapi.nets.faceExpressionNet.loadFromUri('/testing-disini/tensor/v1/models')
]).then(startWebcam);
